  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <span className="text-[10px] font-bold text-[#FFB800] uppercase tracking-widest block">Trophy Case</span>
          <h3 className="font-heading text-lg text-white tracking-wide mt-0.5">{title}</h3>
        </div>
        <span className="px-3 py-1 rounded-full bg-[#FFB800]/15 border border-[#FFB800]/30 text-xs text-[#FFB800] font-bold shadow-inner">
          ...
          return (
            <motion.div
              ...
              className={`relative rounded-2xl p-4 border flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 overflow-hidden ${
                isUnlocked
                  ? "bg-gradient-to-b from-[#FFB800]/20 via-[#141418] to-[#0A0A0A] border-[#FFB800]/50 shadow-[0_10px_25px_rgba(255,184,0,0.18)]"
                  : "bg-[#121215]/80 border-white/5 opacity-50 hover:opacity-80"
              }`}
            >
              {/* Gold Shimmer Pass on Unlocked Badges */}
              {isUnlocked && <div className="absolute inset-0 gold-shimmer pointer-events-none opacity-40" />}
              ...
              <div className={`size-13 rounded-2xl flex items-center justify-center mb-2.5 transition-transform ${
                isUnlocked
                  ? "bg-[#FFB800]/20 text-[#FFB800] border border-[#FFB800]/50 shadow-[0_0_20px_rgba(255,184,0,0.3)] scale-105"
              ...
              {/* Unlocked tag */}
              {isUnlocked && (
                <span className="mt-2.5 text-[9px] font-bold text-[#FFB800] bg-[#FFB800]/15 px-2.5 py-0.5 rounded-full border border-[#FFB800]/30 shadow-sm">
                  Unlocked
                </span>
              )}
            </motion.div>
        ...
        {activeBadge && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-sm rounded-3xl border border-[#FFB800]/40 bg-[#121215] p-6 text-center space-y-4 shadow-[0_0_50px_rgba(0,0,0,0.9)] relative overflow-hidden"
            >
              <div className="absolute -top-16 -left-16 radial-gold-ambient" />
              ...
              <div className={`size-18 mx-auto rounded-3xl flex items-center justify-center ${
                activeBadge.unlocked ? "bg-[#FFB800]/20 text-[#FFB800] border border-[#FFB800]/60 shadow-[0_0_30px_rgba(255,184,0,0.4)]" : "bg-zinc-800/80 text-zinc-500"
              }`}>
                {(() => {
              ...
              <div>
                <span className="text-[10px] uppercase font-bold text-[#FFB800] tracking-widest">{activeBadge.badge.category}</span>
              ...
              {activeBadge.unlocked ? (
                <div className="p-3.5 rounded-2xl bg-gradient-to-r from-[#FFB800]/20 to-[#FFB800]/5 border border-[#FFB800]/40 text-xs text-[#FFB800] font-semibold flex items-center justify-center gap-2">
                  <Trophy className="size-4 text-[#FFB800]" />
