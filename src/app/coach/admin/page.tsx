  ...
  return (
    <CoachLayout>
      ...
      <div className="flex gap-3 overflow-x-auto pb-4 mb-6 snap-x snap-mandatory scrollbar-none">
        ...
        <StatCard icon="⏰" value="3" label="Expiring this week" />
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/coach/clients" className="text-xs text-purple-light hover:text-purple transition-colors">
            View all
          </Link>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/coach/leads" className="text-xs text-purple-light hover:text-purple transition-colors">
            View all
          </Link>
        </div>
        {leads.length > 0 ? (
