            ...
            <div key={i} className="space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-xs font-medium border ${answers[i] === "Yes" ? "bg-accent-gold text-bg-primary border-accent-gold" : "border-border-subtle text-text-muted"}`}
                >
                  Yes
                </button>
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-xs font-medium border ${answers[i] === "No" ? "bg-accent-gold text-bg-primary border-accent-gold" : "border-border-subtle text-text-muted"}`}
                >
                  No
                </button>
              </div>
