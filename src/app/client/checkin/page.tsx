  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await addCheckin({
        ...
        // Extended feedback fields stored via the checkins table extra columns
        // @ts-expect-error -- extra columns added via migration
        workout_energy: form.workoutEnergy,
        workout_days: form.workoutDays ? Number(form.workoutDays) : undefined,
        workout_deviation: form.workoutDeviation,
        exercise_issues: form.exerciseIssues,
        cardio_achievement: form.cardioAchievement,
        diet_deviation: form.dietDeviation,
        appetite: form.appetite,
        digestion: form.digestion,
        stool_frequency: form.stoolFrequency,
        diet_change_request: form.dietChangeRequest,
        food_add_remove: form.foodAddRemove,
        daily_energy: form.dailyEnergy,
        sleep_quality: form.sleepQuality,
        water_intake: form.waterIntake,
        urine_color: form.urineColor,
        coaching_feeling: form.coachingFeeling,
